...
for num_prompts in num_prompts_list:
    for variant in parameter_dict.keys():
        ...
        os.system("rm -rf my_llama_checkpoint_1b")
        checkpoint_path = "my_llama_checkpoint_1b"
        ...
        while True:
            ...
            if len(generated_text) == output_tokens:
                ...
                print(f"variants_vllm_hs_{hidden_size}_layers_{num_hidden_layers}_bs_{num_prompts}_InputTokens_{input_tokens}_OutputTokens_{output_tokens}_trial_{trial}")
